// Cloudflare Pages Function — serverless, free tier.
// Route: POST /api/chat
// Keeps the Groq API key server-side (set as a secret env var in the
// Cloudflare Pages dashboard, never committed to the repo).
